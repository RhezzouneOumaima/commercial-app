                        ...
                        <li ><a href="{{ url('/main/successlogin') }}"><i class="ti-receipt"></i> <span>Accueil</span></a></li>
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="{{ url('/listStock') }}">Fiche de stock</a></li>
                                    <li class="active"><a href="{{ url('/alertStock') }}">Alerte de stock</a></li>
                                </ul>
                            </li>
                            <li>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Alert de stock</span></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="header-title">Liste des alertes</h4>
                                <button type="button" class="btn btn-rounded btn-primary mb-3" onclick="location.href='{{ url('/listAlert') }}'">imprimer la liste</button>
