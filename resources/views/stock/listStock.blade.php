            ...
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        ...
                        <li ><a href="{{ url('/main/successlogin') }}"><i class="ti-receipt"></i> <span>Accueil</span></a></li>
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-dashboard"></i><span>Gestion de stock</span></a>
                                <ul class="collapse">
                                    <li  class="active"><a href="{{ url('/listStock') }}">La liste de stock</a></li>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Liste de stock</span></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="header-title">Liste de stock</h4>
                                <button type="button" class="btn btn-rounded btn-primary mb-3" onclick="location.href='{{ url('/listpdts') }}'">imprimer la liste de stock</button>
                                <button type="button" class="btn btn-rounded btn-primary mb-3" onclick="location.href='{{ url('/addProduct') }}'">nouveau produit</button>
                                    ...
                                    <table id="dataTable" class="text-center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$pdt['PVG']}}</td>
                                                <td>{{$pdt['stock']}}</td>
                                                <td> <a href={{"deleteP/".$pdt['id']}}><i class="ti-trash"></i></a>
                                                &nbsp <a href={{"editProduct/".$pdt['id']}}><i class="fa fa-edit"></i></a>
                                                &nbsp <a href={{"pdtPictures/".$pdt['id']}}><i class="fa fa-file-image-o"></i></a></td>
