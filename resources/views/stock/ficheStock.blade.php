                        ...
                        <li ><a href="{{ url('/main/successlogin') }}"><i class="ti-receipt"></i> <span>Accueil</span></a></li>
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="{{ url('/listStock') }}">Fiche de stock</a></li>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Fiche de stock</span></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="header-title">Fiche de Stock</h4>
                                    ...
                                    <table id="dataTable3" class="text-center">
                                        <thead class="text-capitalize">
                                            <tr>
                                                <th>Designation</th>
                                                <th>Stock</th>
                                                <th>La liste des mouvements</th>
                                                <th>Ajouter un entree</th>
                                                <th>Ajouter une sortie</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach($Pdts as $pdt)
                                            <tr>
                                                <td>{{$pdt['RefPdt']}}</td>
                                                <td>{{$pdt['stock']}}</td>
                                                <td><a href={{"listMov/".$pdt['id']}}><i class="fa fa-list"></i></td>
                                                <td><a href={{"addMovPageEntree/".$pdt['id']}}><i class="fa fa-indent"></i></a></td>
                                                <td> <a href={{"addMovPageSortie/".$pdt['id']}}><i class="fa fa-outdent"></i></a></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
