                        ...
                        <li ><a href="{{ url('/main/successlogin') }}"><i class="ti-receipt"></i> <span>Accueil</span></a></li>
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="{{ url('/avoirClt') }}">Avoir Client</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="header-title">Liste des avoirs client</h4>
                                <button type="button" class="btn btn-rounded btn-primary mb-3" onclick="location.href='{{ url('/addBA') }}'">nouveau avoir </button>
                                    ...
                                    <table id="dataTable" class="text-center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$ba->date}}</td>
                                                <td>{{$ba->total}}</td>
                                                <td> <a href={{"deleteBA/".$ba->id}}><i class="ti-trash"></i></a>
                                                &nbsp <a href={{"editBA/".$ba->id}}><i class="fa fa-edit"></i></a>
                                                &nbsp <a href={{"detailsBA/".$ba->id}}><i class="fa fa-tasks"></i></a>
                                                &nbsp <a href={{"printBA/".$ba->id}}><i class="fa fa-print"></i></a></td>
