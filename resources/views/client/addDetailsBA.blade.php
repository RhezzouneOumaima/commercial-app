    ...
    <div class="login-area">
        <div class="container">
            <div class="login-box ptb--100">
                <form method="POST" action="{{ url('/addDetailsBAForm') }}">
                @csrf
                    <div class="login-form-head">
                        <h4>Ajouter nouveau produit pour BA num {{$id}}</h4>
                ...
                @endif
                    ...
                    <div class="form-gp">
                            ...
                            <option value="{{$data->id}}">BL num:{{$data->idBL}} Pdt:{{$data->RefPdt}} (QTE:{{$data->qt}})</option>
                            @endforeach
                                </select>
                        ...
                        <br>
                        <div class="submit-btn-area">
                            <button id="form_submit" type="button" onclick="location.href='{{ url('/detailsBA/'.$id) }}'"><i class="ti-arrow-left"></i>  Retour </button>
                        </div>
