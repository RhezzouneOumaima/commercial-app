    ...
    <div class="login-area">
        <div class="container">
            <div class="login-box ptb--100">
                <form method="POST" action="{{ url('/addBLForm') }}">
                @csrf
                ...
                @endif
                    ...
                    <div class="form-gp">
                        ...
                        <div class="form-gp">
                            ...
                            <input type="text" id="exampleInputEmail2" class="form-control @error('rep') is-invalid @enderror"  name="rep">
                            <div class="text-danger"></div>
                            @error('rep')
                                  <span class="invalid-feedback" role="alert">
                                      <strong>{{ $message }}</strong>
                        ...
                        <div class="form-gp">
                            ...
                            <select id="exampleInputEmail3" class="form-control @error('mode') is-invalid @enderror"  name="mode">
                        ...
                        <div class="form-gp">
                            ...
                            <input type="text" id="exampleInputEmail4" class="form-control @error('rem') is-invalid @enderror"  name="rem">
                            <div class="text-danger"></div>
                            @error('rem')
                                  <span class="invalid-feedback" role="alert">
                                      <strong>{{ $message }}</strong>
