                        ...
                        <li ><a href="{{ url('/main/successlogin') }}"><i class="ti-receipt"></i> <span>Accueil</span></a></li>
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="{{ url('/listBL') }}">Livraison</a></li>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Les bons de livraison</span></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="header-title">Liste des BLs</h4>
                                <button type="button" class="btn btn-rounded btn-primary mb-3" onclick="location.href='{{ url('/addBL') }}'">nouveau BL </button>
                                    ...
                                    <table id="dataTable" class="text-center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$bl->Clt}}</td>
                                                <td>{{$bl->date}}</td>
                                                <td>{{$bl->Representant}}</td>
                                                <td>{{$bl->ModeReg}}</td>
                                                <td>{{$bl->Remarque}}</td>
                                                <td>{{$bl->total}}</td>
                                                <td> <a href={{"deleteBL/".$bl->id}}><i class="ti-trash"></i></a>
                                                &nbsp <a href={{"editBL/".$bl->id}}><i class="fa fa-edit"></i></a>
                                                &nbsp <a href={{"detailsBL/".$bl->id}}><i class="fa fa-tasks"></i></a>
                                                &nbsp <a href={{"printBL/".$bl->id}}><i class="fa fa-print"></i></a></td>
